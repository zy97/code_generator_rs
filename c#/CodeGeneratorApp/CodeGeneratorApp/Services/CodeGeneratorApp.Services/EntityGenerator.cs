...
namespace CodeGeneratorApp.Services
{
    ...
    public partial class EntityGenerator : IDisposable
    {
        ...
        public static EntityGenerator New(string path)
        {
            ...
            var rval = EntityGeneratorInterop.entity_service_new(ref self._context, path);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        public void Dispose()
        {
            var rval = EntityGeneratorInterop.entity_service_destroy(ref _context);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            var rval = EntityGeneratorInterop.entity_service_create_dto(_context);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            var rval = EntityGeneratorInterop.entity_service_create_createorupdatedto(_context);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            var rval = EntityGeneratorInterop.entity_service_create_ef_repository(_context);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            var rval = EntityGeneratorInterop.entity_service_create_exception(_context, exception_name, exception_code, exception_displayname);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            var rval = EntityGeneratorInterop.entity_service_create_iservice(_context, custom);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            var rval = EntityGeneratorInterop.entity_service_create_manager(_context);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            var rval = EntityGeneratorInterop.entity_service_create_pagedandsortedandfilterresultdto(_context);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            var rval = EntityGeneratorInterop.entity_service_create_repository_interface(_context);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            var rval = EntityGeneratorInterop.entity_service_create_service(_context, custom);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            var rval = EntityGeneratorInterop.entity_service_insert_mapper(_context);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            var rval = EntityGeneratorInterop.entity_service_insert_efcore_entity_config(_context);
            if (rval != AppFFIError.Ok)
            {
                throw new InteropException<AppFFIError>(rval);
            }
        ...
        {
            EntityGeneratorInterop.entity_service_format_all(_context);
        }
